...
public class PantallaDetalles extends GridPane {
    ...
    public PantallaDetalles(Stage stage, Pastel pastel){
        setStyle("-fx-background-color: #ecf0f1");
        this.stage=stage;
        this.pastel=pastel;
        lId = new Label("ID: "+pastel.getId());
        ...
        lNoPisos = new Label("No pisos: "+ pastel.getPisos());
        lPrecio = new Label("Precio: $"+pastel.getPrecio());
        lTamano = new Label("Tamano: "+pastel.getTamano());
