package com.proyecto.pasteleria.Graficas;
...
public class PantallaGraficas extends BorderPane {
    private boolean compactado = true;
    private ToolBar menuHamburguesa;
    private  Label titulo;
    public PantallaGraficas(){
        ...
        URL rMenu = getClass().getResource("menuHamburguesa.png");
